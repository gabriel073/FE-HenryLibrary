...
export function getUserPaymentsBook(uid, id) {
  return function (dispatch) {
    axios
      .get(`/user/bookpayments/${uid}?id=${id}`)
      .then((response) => {
        dispatch({
